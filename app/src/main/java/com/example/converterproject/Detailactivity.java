...
public class Detailactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Type("Binary Operations","Perform fundamental arithmatic operations with ease using this feature.Addition,subtraction,multiplication and division are seamlessly executed"));
